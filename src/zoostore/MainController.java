...
import zoostore.model.ImageTextCell;
import zoostore.model.Customer;
import zoostore.model.Product;
import zoostore.model.ProductQueries;
...
public class MainController {
        ...
        gamesListView.getSelectionModel().selectedItemProperty().addListener(
                (observableValue, oldValue, newValue) -> {
                        ...
                        if(alreadyPurchasedProducts.contains(newValue.getProductID())) {
                            addToCartButton.setText("Już zakupione");
                            addToCartButton.setDisable(true);
                        } else {
                            addToCartButton.setText("Dodaj do koszyka");
    ...
    public void addToCartButtonClicked(ActionEvent event) throws Exception {
        ...
        if(cartItems.contains(getSelectedProduct())) {
            ...
            alert.getDialogPane().setContentText("Każdy zakup jest powiązany z Twoim kontem w celu łatwego i szybkiego odnajdowania zamówień..");
    ...
    public void showHelp(ActionEvent event) {
        ...
        alert.getDialogPane().setContentText("Zoo Store to sklep w którym można kupować akcesoria dla swoich pupili.");
        alert.getDialogPane().setHeaderText(null);
